...
### WebGPU
This is the hardware accelerated backend. You should use it if possible for best performance. Currently there is no implementation as I'm waiting for Linux to get more stable webgpu support.
